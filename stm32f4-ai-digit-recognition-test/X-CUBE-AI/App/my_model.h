...
#define AI_MY_MODEL_IN_1_SIZE  (1 * 28 * 28)
#define AI_MY_MODEL_IN_1_SIZE_BYTES  ((1 * 28 * 28) * 4)
...
#define AI_MY_MODEL_OUT_1_SIZE  (1 * 1 * 10)
#define AI_MY_MODEL_OUT_1_SIZE_BYTES  ((1 * 1 * 10) * 4)
